...
require 'lib/dsl/domain_util'

class DomainUtilTest < Minitest::Test
  def test_normalize_name
    result = Dsl::DomainUtil.normalize_name 'aaa.example.com'
    assert_equal 'aaa_example_com', result

    result = Dsl::DomainUtil.normalize_name 'abc-ABC.012@xxx:yyy#zzz'
    assert_equal 'abc_ABC_012_xxx_yyy_zzz', result
    
    str = %/!"#$%&'()-^=~@`[]{};:+*,.<>?\/_\\/
    result = Dsl::DomainUtil.normalize_name str
